  ...
  return knex('books').del()
    .then(function () {
      ...
      return knex('books').insert([
        ...
        { isbn: '0-9123-2134-2', title: 'Tiny Pretty Things', theme1: 'Discrimination', theme: 'Mystery', genre1: 'Young Adult Novel', genre2: 'Contemporary', date: '26-05-2015', recommended: false, price: '9.90', status: 'available', sold: 100 }
      ]);
    });
};
