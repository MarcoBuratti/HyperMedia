  ...
  return knex('events').del()
    .then(function () {
      ...
      return knex('events').insert([
        ...
        {id_event: 2, name:'After all this time? Always.', isbn: '0-684-19723-7', date: '13/07/2019', description: "After bla bla bla"},
        {id_event: 3, name:"It's me, Kate, I've come home", isbn: '0-358-31746-2', date: '13/10/2019', description: "Evento 2 presenta libro 2"},
        {id_event: 4, name:"Tiny Pretty Books", isbn: '0-358-31746-2', date: '28/09/2019', description: "Tiny bla bla bla"}
      ]);
    });
};