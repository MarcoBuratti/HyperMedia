...
async function loadData(json) {
    for(var i=0; i<json.length; i++) {
        ...
        if (json[i].title.charAt(0).match(/[a-z]/i)) {
            ...
            "<a class='collection-item' , href='../pages/sidebar.html?event=" + json[i].id_event + "'>" + json[i].name + "<br><img src='" + "../assets/img/books/" + json[i].isbn + ".jpg' height='300' width='180'></a>" +
            "<h4>Book: " + json[i].title + "</h4>";
